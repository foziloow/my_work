...
import random
# db - ma'lumot ombori 
# SQL - ma'limot ombori tili

# ombor bog'lanish  uchun obyekt 
...
# cur.execute(sql)
# names=['dima','sara','mike','bob','jorj','brain','marcus','alex','dani','miguel']
# for i in range(10):
...
# else:
#     cur.close() # omborni boshqarishni toxtatish 
...
# data = cur.execute("SELECT name,point FROM students WHERE name='brain'")
# print(data.fetchone())


data = cur.execute("SELECT name,point FROM students WHERE point >=4")
print(data.fetchall())